...
public class Adapter_Profile_Court extends RecyclerView.Adapter<Adapter_Profile_Court.MyViewHolder> {
    ...
    public Adapter_Profile_Court(Context context, List<Court> _courts) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.list_profile_courts, parent, false);
